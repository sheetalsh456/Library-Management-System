...
<div class="p" style="font-size:25px;color:white;padding-LEFT=10px"> 
	<center><table align="center" class="bleh" width="40%" height="40%" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;">
<tr>
<td>
<br><center><img src="pic.png" alt="Profile Picture" style="float:middle;padding=20px;width:80px;height:80px;vertical-align: middle;font-size:30px;color:white;margin-right:10px;"><?=$firstname?> <?=$middlename?> <?=$lastname?></center>
<br>
</td>
</tr>
</table></center>
...
<tr>
<td><center><p style="font-size:20px;color:white;padding-LEFT:20px;padding-top:15px"><b>College ID : <?=$college_id?></p></center>
</td>
</tr>
</table></center>
...
<center><table align="center" class="bleh" width="40%" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;">
<tr>
<td><center><p style="font-size:20px;color:white;padding-LEFT:20px;padding-top:15px;"><b>Account Type : <?=$acct_type?></p></center>
</td>
</tr>
</table></center>
...
<center><table align="center" class="bleh" width="40%" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;">
<tr>
<td><center><p style="font-size:20px;color:white;padding-LEFT:20px;padding-top:15px;"><b>DOB : <?=$dob?></p></center>
</td>
</tr>
</table></center>
...
<center><table align="center" class="bleh" width="40%" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;">
<tr>
<td><center><p style="font-size:20px;color:white;padding-LEFT:20px;padding-top:15px"><b>Phone : <?=$phone?></p></center>
</td>
</tr>
</table></center>
...
<center><table align="center" class="bleh" width="40%" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;">
<tr>
<td><center><p style="font-size:20px;color:white;padding-LEFT:20px;padding-top:15px;"><b>Email : <?=$email?></p></center>
</td>
</tr>
</table></center>
