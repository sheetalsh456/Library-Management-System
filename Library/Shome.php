...
$freq = mysql_query("SELECT * FROM Books ORDER BY Frequency DESC LIMIT 6");
/*$freqrow = mysql_fetch_array($freq);
$url = $freqrow['imglink'];*/
$freqrow = array();
$freqrow1 = array();
while($row = mysql_fetch_array($freq)) {
    $freqrow[] = $row['imglink'] ;
    $freqrow1[] = $row['Book_Name'];
}
?>
...
/*body{
	background: url("book.jpg") no-repeat center center fixed; 
  	...
  	-o-background-size: cover;
  	background-size: cover;*/
	/*background:url("BackgroundAdmin1.jpg")  ;
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row main-div">
           ...
           <div id="MainMenu">
            <div class="list-group panel">
              ...
              <div class="collapse" id="profile">
                ...
                <a href="cIndividual_view_books.php" class="list-group-item"><i class="material-icons">done_all</i>View Books</a>
                <a href="Lchangepass.php" class="list-group-item"><i class="material-icons">mode_edit</i>Change password</a>  
                 <a href="Lupload.php" class="list-group-item"><i class="material-icons">account_circle</i>Change Picture</a>                 
              </div>
        ...
        <?php echo '<div class="row" style="margin:30px;">
...
<div class="col-md-12" style="padding:20px;">
        ...
        <!--content goes here-->
      <center><div class="bleh" align="center" width="100%" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:5px;border:none;box-shadow:2px 2px 1px #aaa;padding:40px;"><tr>
<td><center><p style="font-size:20px;color:white;padding-LEFT:20px"><b>A Library Management System is developed for the efficient and secure maintenance of a library. It automates the entire process of requesting and issuing books.  Thus, makes life easier for the students as well as professors.<br>Our system has 3 types of access
<ul style="color:white">
<li> Admin</li>
<li> Student</li>
<li>Professor</li>
</ul></p></center><br><br><hr><br>
</td>
</tr>

		<div class="row" align="left" style="color:white;font-size:30px;padding-left:20px;padding-bottom:20px;" >Frequently Borrowed Books</div><br>
		<div class="row" ><div class="col-md-4"><img src="' . $freqrow[0]. '" style="width:250px;height:300px;"></div>
		<div class="col-md-4"><img src="' . $freqrow[1]. '" style="width:250px;height:300px;"></div>
		<div class="col-md-4"><img src="' . $freqrow[2]. '" style="width:250px;height:300px;"></div></div><br>
		
		<div class="row" ><div class="col-md-4" style="color:white;">' . $freqrow1[0]. '</div>
		<div class="col-md-4" style="color:white;">' . $freqrow1[1]. '</div>
		<div class="col-md-4" style="color:white;">' . $freqrow1[2]. '</div></div><br><br><br>

	
		<div class="row"><div class="col-md-4"><img src="' . $freqrow[3]. '" style="width:250px;height:300px;"></div>
		<div class="col-md-4"><img src="' . $freqrow[4]. '" style="width:250px;height:300px;"></div>
		<div class="col-md-4"><img src="' . $freqrow[5]. '" style="width:250px;height:300px;"></div></div><br>
		
		<div class="row" ><div class="col-md-4" style="color:white;">' . $freqrow1[3]. '</div>
		<div class="col-md-4" style="color:white;">' . $freqrow1[4]. '</div>
		<div class="col-md-4" style="color:white;">' . $freqrow1[5]. '</div></div><br>
