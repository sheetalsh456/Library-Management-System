...
<div class="col-md-4">Books Issued</div>
...
<?php
  ...
  while($issuedrow=mysql_fetch_array($issued))
  {
      ...
      $fi = $issuedrow['Fine'];
      $b1 = mysql_query("SELECT * FROM Books WHERE Book_ID = '$book_id'");
...
<div class="col-md-3">Books Requested</div>
</div>
<hr>
<br><br>
<?php
  ...
  {
      $book_id1 = $requestedrow['Book_ID'];
      $b11 = mysql_query("SELECT * FROM Books WHERE Book_ID = '$book_id1'");
      $b21 = mysql_fetch_array($b11);
      $book_name1 = $b21['Book_Name'];
  ?>
  <div class="row" style="color:white">
  <div class="col-md-1"><?=$j?></div>
  <div class="col-md-3"><?=$full_name?></div>
  <div class="col-md-3"><?=$book_name1?></div>
  </div>
  <hr>
