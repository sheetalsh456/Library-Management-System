...
<div class="p" style="font-size:25px;color:white;padding-LEFT=10px"> 
	...
	<center><table align="center" class="bleh" width="70%" border="0" style="background:rgba(0,0,0,0.85);">


<tr>
<td><p style="font-size:20px;color:white;"><center><b>ABOUT THE SOFTWARE</center></p>
</td>
</tr>

<tr>
<td><p style="font-size:20px;color:white;padding:60px">The Library Management System is an automation of a college library which aims at minimising the amount of manual work to be done by the Library staff. This software uses 3 modules - Administrator, Student and Teacher. Using this software, a student can browse for books, view its details, check for its availability and place a request for the book. He can also rate a book and comment on it, which will in turn help the other students to select books. The system automatically updates and notifies the user regarding details like newly added books, next due date and fine due. A teacher can borrow books from the library as well. Teacher can also recommend new books to the administrator, which the administrator considers and either adds or ignores the book. The administrator handles the smooth functioning of the application by ensuring that there are no inconsistent data in the database. This software efficiently utilises SQL database to implement the college library system. </p>
</td>
</tr>
</table></center>
</div>
