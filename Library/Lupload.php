            ...
            <div class="list-group panel">
             <a href="Shome.php" class="list-group-item" data-parent="#MainMenu"><i class="material-icons">home</i>Home</a>
              ...
              <div class="collapse" id="profile">
                ...
                <a href="Individual_view_books.php" class="list-group-item"><i class="material-icons">done_all</i>View Books</a>
...
<center><table align="center" width="400px" border="0" style="background:rgba(0,0,0,0.85);border:none;box-shadow:2px 2px 1px #aaa;"">


<tr>
<td><p style="font-size:30px;color:white;"><center><b>CHANGE PROFILE PICTURE</p></center>
</td>
</tr>
</table></center>

<br>
<center><table align="center" class="bleh" width="600px" border="0" style="background:rgba(0,0,0,0.85);border:none;box-shadow:2px 2px 1px #aaa;">
<tr>
 <td><form action="demo_form.asp" class="blehf" style="font-size:20px;margin-left:10px;"><br>
  Select image <input type="file" name="pic" accept="image/*" style="color:white;background:none;border:none;margin-top:10px;align:left"><br>
<input type="submit" style="color:black;background-color:#ffffff;width:15%;align:left;border:none;border-radius:15px;padding-right:10px;margin-left:10px;" value="UPLOAD"><br>
</form>
</td>
</tr> 

<tr>
<td><br><a href="editprofile.html" style="font-size:20px;margin:10px;">Remove Picture?</a></center><br>
</td>
</tr>
</table></center>
</div>
