...
if(isset($_POST['reco']))
{
 ...
 if(mysql_query("INSERT INTO Recommendations(Account_ID,R_Book_Name,R_Book_Author,Department,Topic) VALUES('$account_id','$book_name','$author_name','$dept','$topic')"))
 {
  ?>
        <script>alert('successfully recommended');</script>
        <?php
 }
}
?>
...
<td><center><p style="font-size:30px;color:white;padding-LEFT:20px"><b>RECOMMEND A BOOK</p></center>
</td>
</tr>
</table></center>
...
<center><table align="left" class="bleh" width="450px" height="40px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;"><tr>
 <tr>
 <form method="post">
 <td><div class="blehf" style="margin-left:10px;font-size:20px;padding-top:20px;margin-left:50px;align:left;">
  Book: <input type="text" style="width:300px;height:30px;color:black;" value="" name="book_name" ><br><br>
</div>
</td>
</tr>
</table></center>

<center><table align="center" class="bleh" width="450px" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;"><tr>
 <tr>
 <td><div class="blehf" style="margin-left:10px;font-size:20px;padding-top:20px;margin-left:50px;align:left">
  Author : <input type="text"  style="width:300px;height:30px;color:black;" value="" name="author_name"><br><br><div>
</td>
</tr>
</table></center>
...
<center><table align="center" class="bleh" width="450px" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;"><tr>
 <tr>
 <td><div class="blehf" style="margin-left:10px;font-size:20px;padding-top:20px;margin-left:50px;align:left">
  Department: <input type="text"  style="width:250px;height:30px;color:black;" value="" name="dept"><br><br><div>
</td>
</tr>
</table></center>
<br>
...
<center><table align="center" class="bleh" width="450px" height="60px" border="0" style="background:rgba(0,0,0,0.85);margin:15px;border:none;box-shadow:2px 2px 1px #aaa;"><tr>
 <tr>
 <td><div class="blehf" style="margin-left:10px;font-size:20px;padding-top:20px;margin-left:50px;align:left">
  Topic : <input type="text"  style="width:300px;height:30px;color:black;" value="" name="topic"><br><br><div>
</td>
</tr>
</table></center>


<center><b><input type="submit" name="reco" style="font-size:20px;color:black;background-color:#ffffff;width:15%;height:40px;border-radius:15px;align:left;margin-bottom:10px;border:none;" value="SUBMIT"></b></center>
</form>
</td>
</table>
